...
{
   /** 
    * Returns the fully qualified class name of the destination type.
   ...
   /**
    * Returns the {@link MessageDestinationUsage}
    * @return
    */
   MessageDestinationUsage getMessageDestinationUsage();
 
   /**
    * Returns the link to the message destination reference
    * @return
    */

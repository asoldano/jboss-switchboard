 ...
 * @version $Revision: $
 */
public class EJBReference extends AbstractEJBReference implements EJBReferenceType
{

   private EJBReferenceMetaData ejbReferenceDelegate;
   
   public EJBReference(EJBReferenceMetaData delegate)
   {
      super(delegate);
      this.ejbReferenceDelegate = delegate;
   }
